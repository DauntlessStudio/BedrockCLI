...
std::string attachable_default = R"({ "format_version": "1.12.0", "minecraft:attachable": { "description": { "identifier": "namespace:example_weapon", "materials": { "default": "entity_alphatest", "enchanted": "entity_alphatest_glint" }, "textures": { "default": "textures/entity/item/example_weapon", "enchanted": "textures/misc/enchanted_item_glint" }, "geometry": { "default": "geometry.player.example_weapon" }, "animations": { "ctrl.example_weapon": "controller.animation.weapon.custom_weapons.example_weapon", "example_weapon.attack.first_person": "animation.weapon.example_weapon.attack.first_person", "example_weapon.attack.third_person": "animation.weapon.example_weapon.attack.third_person", "example_weapon.idle": "animation.weapon.example_weapon.idle" }, "scripts": { "pre_animation": [ "v.is_first_person = c.is_first_person;", "v.attack_time = 0;" ], "animate": [ "ctrl.example_weapon" ] }, "render_controllers": [ "controller.render.item_default" ] } } })";
